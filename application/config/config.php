...
$config['db_username'] = $FQDBUSERNAME;
$config['db_password'] = $FQDBPASSWORD;
$config['db'] = $FQDBNAME;
$config['admin_controllers_folder'] 	= $FQADMINFOLDERNAME; //No trailing slash?>